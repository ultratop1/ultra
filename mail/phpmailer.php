...
class PHPMailer
{
    ...
    public function preSend()
    {
        ...
        try {
            ...
            if (!empty($this->DKIM_domain) and !empty($this->DKIM_selector) and (!empty($this->DKIM_private_string) or (!empty($this->DKIM_private) and file_exists($this->DKIM_private)))) {
    ...
    {
        $renamed_langcodes = ['br' => 'pt_br', 'cz' => 'cs', 'dk' => 'da', 'no' => 'nb', 'se' => 'sv', 'sr' => 'rs', ];
